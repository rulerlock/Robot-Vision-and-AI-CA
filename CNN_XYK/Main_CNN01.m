...
figure;
subplot(2,1,1);
plot(trainingMetrics.TrainingAccuracy, '-o');
hold on;
plot(trainingMetrics.ValidationAccuracy, '-x');
title('Accuracy');
xlabel('Iteration');
ylabel('Accuracy');
...
subplot(2,1,2);
plot(trainingMetrics.TrainingLoss, '-o');
hold on;
plot(trainingMetrics.ValidationLoss, '-x');
title('Loss');
xlabel('Iteration');
ylabel('Loss');
